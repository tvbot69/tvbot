...
export const FmButtonMetaList: FmButtonMeta[] = [
  ...
  { flag: FmButton.AppleMusicLink, label: 'Apple Music', emoji: '🍎', isLink: true },
  { flag: FmButton.RymLink, label: 'RYM', emoji: '⭐', isLink: true },
  { flag: FmButton.TrackLove, label: 'Love', emoji: '❤️', customId: 'track-love' },
  { flag: FmButton.TrackUnlove, label: 'Unlove', emoji: '💔', customId: 'track-unlove' },
  { flag: FmButton.TrackPreview, label: 'Preview', emoji: '▶️', customId: 'track-preview' },
  { flag: FmButton.TrackLyrics, label: 'Lyrics', emoji: '📜', customId: 'track-lyrics' },
